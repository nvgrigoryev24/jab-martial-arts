      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-red-500 mb-4">JAB</h3>
            <p className="text-gray-300 mb-4">
              Профессиональная школа единоборств. Развиваем силу, выносливость и характер.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-white transition-colors cursor-glove">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#services" className="text-gray-300 hover:text-white transition-colors cursor-glove">
                  Виды единоборств
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 JAB - Школа единоборств. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
