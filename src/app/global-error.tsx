...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  ...
  return (
    <html lang="ru">
      <body className="h-screen w-full bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center relative overflow-hidden">
        ...
        <div className={`relative z-10 text-center max-w-4xl mx-auto px-6 transition-all duration-1000 ${
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
            Произошла критическая ошибка, которая привела к полной недоступности системы. 
            Наши инженеры уже работают над решением проблемы. Пожалуйста, попробуйте обновить страницу.
          </p>
          ...
          <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mb-8 max-w-md mx-auto">
            <div className="flex items-center justify-center gap-2 text-red-300">
              ...
              <span className="text-sm font-medium">Система полностью недоступна</span>
            </div>
          </div>
