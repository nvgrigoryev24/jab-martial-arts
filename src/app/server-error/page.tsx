    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className={`relative z-10 text-center max-w-4xl mx-auto px-6 transition-all duration-1000 ${
        ...
        <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
          Произошла техническая ошибка. Наши серверы временно недоступны или 
          возникла проблема с загрузкой данных. Мы уже работаем над решением.
        </p>

        {/* Дополнительная информация */}
        <div className="mb-8 p-6 bg-red-900/20 border border-red-500/30 rounded-lg">
          <h3 className="text-red-400 font-bold mb-4 text-xl">Возможные причины:</h3>
          <ul className="text-gray-300 text-left space-y-2">
            <li className="flex items-center gap-2">
              <span className="w-2 h-2 bg-red-500 rounded-full"></span>
              База данных PocketBase недоступна
            </li>
            <li className="flex items-center gap-2">
              <span className="w-2 h-2 bg-red-500 rounded-full"></span>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button 
            ...
            className="group relative px-8 py-4 border border-gray-600 text-gray-300 hover:border-red-500 hover:text-red-400 font-bold rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
          >
            <svg className="w-5 h-5 transition-transform group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
            </svg>
        ...
        <div className="mt-12 text-sm text-gray-500">
          <p>Если проблема не решается, свяжитесь с технической поддержкой</p>
          <div className="flex justify-center space-x-6 mt-4">
            <a href="mailto:support@jab-martial-arts.ru" className="hover:text-red-400 transition-colors">
              support@jab-martial-arts.ru
            </a>
