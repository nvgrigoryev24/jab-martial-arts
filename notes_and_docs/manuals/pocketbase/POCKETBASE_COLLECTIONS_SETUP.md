...
### 4. 💰 **Тарифные планы** (pricing_plans)
...
### 5.1. 🏷️ **Категории новостей** (news_categories)
...
### 5.3. ✍️ **Авторы новостей** (news_authors)
...
### 5.4. 😊 **Реакции на новости** (news_reactions)
...
### 6.2. 🎯 **Уровни подготовки** (training_levels)
...
**Описание:** Вопросы и ответы для посетителей

**Поля для создания:**
- `question` (Text) - Текст вопроса
- `answer` (Editor) - Подробный ответ
- `category` (Select) - Выберите: Цены и оплата, Тренировки, Расписание, Оборудование, Возраст, Запись
...
- `category`: Обязательное поле, выбор из списка
- `is_active`: Обязательное поле
- `sort_order`: Обязательное поле, только числа, минимум 1, максимум 1000

---

### 8. 📞 **Заявки на запись** (contacts)
...
### 8.1. 📍 **Контактная информация** (contact_info)
...
### 9. 🎬 **Настройки прелоудера** (preloader_settings)
