...
- `subtitle` (Text) - Подзаголовок/описание
- `background_image` (File) - Фоновое изображение на весь экран
...
- `subtitle`: Обязательное поле, минимум 20 символов, максимум 300
...
```json
{
  ...
  "background_image": "promo-kids-sport.jpg",
