...
### 3. 💰 **Тарифные планы** (pricing_plans)
...
### 4.1. 🏷️ **Категории новостей** (news_categories)
...
### 4.3. ✍️ **Авторы новостей** (news_authors)
...
### 4.4. 😊 **Реакции на новости** (news_reactions)
...
### 6. 🎯 **Уровни подготовки** (training_levels)
...
### 10. 📍 **Контактная информация** (contact_info)
...
### 11. 🎬 **Настройки прелоудера** (preloader_settings)
...
- [ ] Все 14 коллекций созданы в правильном порядке: hero_content, coaches, pricing_plans, news, news_categories, color_theme, news_authors, news_reactions, locations, training_levels, schedule, faq, contacts, contact_info, preloader_settings
